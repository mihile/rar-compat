...
public class CrossNecklaceItem extends WearableRelicItem {
                ...
                .abilities(AbilitiesData.builder()
                        .ability(AbilityData.builder("invulnerability")
                                ...
                                .research(ResearchData.builder()
                                        .star(0, 4, 6).star(1, 11, 6).star(2, 4, 20)
                                        .star(3, 10, 19).star(4, 20, 15).star(5, 18, 21).star(6, 11, 25)
                                        .link(0, 2).link(2, 6).link(6, 5)
                                        .link(4, 1).link(1, 3)
                                        .build())
                                .build())
                        .build())
    ...
    public static class Events {
        ...
        public static void onLivingDamaged(LivingDamageEvent.Post event) {
            ...
            player.invulnerableTime = (int) (20 + (30 * relic.getStatValue(stack, "invulnerability", "multiplier")));
        }
    }
}
